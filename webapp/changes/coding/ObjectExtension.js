...
sap.ui.define([
    ...
    function (
        ...
        return ControllerExtension.extend("ZMM_PPR_MAINST1.ObjectExtension", {

            override: {
                /**
                 * Called when a controller is instantiated and its View controls (if available) are already created.
                 * Can be used to modify the View before it is displayed, to bind event handlers and do other one-time initialization.
                 * @memberOf ZMM_PPR_MAINST1.ObjectExtension
                 */
                onInit: function () {
                    // get view instance
                    _oView = this.getView();
            ...
            _loadCustomerTypes: function () {
                return new Promise((resolve, reject) => {
                    ...
                    if (_bCustomerDataLoaded) {
                        ...
                        // filter
                        let aFilter = [];
                        aFilter.push(new Filter('variable_name', FilterOperator.EQ, 'PR_CUSTOMER_DATA'));
